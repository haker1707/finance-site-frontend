...
function clearAccount(){clearRange();stopClock();clearFinancial();accessEpoch++;lastState=null;workspaceId='';revision=0;selectedFile=null;preview=null;window.norte.clearPrivateData?.();const toast=document.querySelector('#toast');if(toast){toast.textContent='';toast.style.display='none';}}
